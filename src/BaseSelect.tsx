...
export type Mode = 'multiple' | 'tags' | 'combobox' | 'mixed';
...
export function isMultiple(mode: Mode) {
  return mode === 'tags' || mode === 'multiple' || mode === 'mixed';
}

export function isShowSearch(mode: Mode) {
...
const BaseSelect = React.forwardRef((props: BaseSelectProps, ref: React.Ref<BaseSelectRef>) => {
  ...
  const searchable = isShowSearch(mode);
  const mergedShowSearch =
    (showSearch !== undefined ? showSearch : searchable) || mode === 'combobox';
  ...
  const mergedShowArrow =
    showArrow !== undefined
      ? showArrow
      : loading || (!multiple && mode !== 'combobox') || mode === 'mixed';
  ...
  const mergedClassName = classNames(prefixCls, className, {
    ...
    [`${prefixCls}-multiple`]: searchable, //multiple,
    [`${prefixCls}-single`]: !searchable, //multiple,
